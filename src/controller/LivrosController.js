...
export const Livros = app => {
    ...
    app.post('/livros', async (req, res) => {
        ...
        const novoLivro = new LivrosModel(titulo, descricao, categoria, url_img, preco, total_paginas, ano_publicacao, autor)
        const message = {
            success: 'Livro cadastrado com sucesso',
            error: false
        }
        try {
            await LivroDAO.adicionarLivros(bd, novoLivro)
